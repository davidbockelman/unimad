...
const (
	KeyValueStore_ClientHeartbeat_FullMethodName = "/raftkv.KeyValueStore/ClientHeartbeat"
)
...
type KeyValueStoreClient interface {
	ClientHeartbeat(ctx context.Context, in *StringArg, opts ...grpc.CallOption) (*Reply, error)
}
...
func (c *keyValueStoreClient) ClientHeartbeat(ctx context.Context, in *StringArg, opts ...grpc.CallOption) (*Reply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Reply)
	err := c.cc.Invoke(ctx, KeyValueStore_ClientHeartbeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeyValueStoreServer interface {
	ClientHeartbeat(context.Context, *StringArg) (*Reply, error)
...
func (UnimplementedKeyValueStoreServer) ClientHeartbeat(context.Context, *StringArg) (*Reply, error) {
...
func _KeyValueStore_ClientHeartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringArg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyValueStoreServer).ClientHeartbeat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeyValueStore_ClientHeartbeat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyValueStoreServer).ClientHeartbeat(ctx, req.(*StringArg))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _KeyValueStore_ClientHeartbeat_Handler,
		},
	},
